...
export const Henry = ({ className = "" }: { className?: string }) => (
  <svg className={className} viewBox="0 0 48 48" fill="none">
...
export const Nathan = ({ className = "" }: { className?: string }) => (
  <svg className={className} viewBox="0 0 48 48" fill="none">
...
export const Rachel = ({ className = "" }: { className?: string }) => (
  <svg className={className} viewBox="0 0 48 48" fill="none">
...
export const Frank = ({ className = "" }: { className?: string }) => (
  <svg className={className} viewBox="0 0 48 48" fill="none">
...
export const Claire = ({ className = "" }: { className?: string }) => (
  <svg className={className} viewBox="0 0 48 48" fill="none">
...
export const CREW_META: Record<string, { name: string; role: string; desc: string }> = {
  triage: { name: "Olivia", role: "the Sorter", desc: "Classifies severity with MITRE ATT&CK." },
  threat_intel: { name: "Henry", role: "the Investigator", desc: "Enriches IPs against AbuseIPDB feeds." },
  investigation: { name: "Nathan", role: "the Connector", desc: "Correlates threats into incidents." },
