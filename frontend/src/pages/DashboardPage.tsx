    ...
    <div className="space-y-6 sm:space-y-8 pb-12">
      ...
      {waking && !error && (
        <motion.div
          ...
          className="relative overflow-hidden bg-card border border-border rounded-xl px-5 py-4"
        >
          <div className="flex items-start gap-3.5">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="text-[12.5px] text-muted-foreground mt-1 leading-[1.55] max-w-2xl">
                The demo backend sleeps when idle to conserve resources. The
                first request can take up to a minute — this view refreshes
                automatically the moment it responds.
              </p>
